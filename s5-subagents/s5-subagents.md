...
| 25-35 | ハンズオン #1 (独自 Subagent 作成: reviewer) |
| 35-50 | 講師デモ + ハンズオン #2 (全員で並列委譲を実行) |
| 50-60 | 3 製品比較 + まとめ |
...
| 第5回 | Sub-agents | 重い作業を **別の実行主体** に委譲し、並列化する |
...
- 製品（Antigravity / Codex / Claude Code）は思想の違いで選ぶもの — 概念が身につけばどれでも応用可能
