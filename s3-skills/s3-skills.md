...
| 時間 | パート |
|---|---|
| 0-5 | イントロ + このセッションのゴール |
| 5-15 | 素のエージェントの限界 / 巨大なルールブックの失敗 |
| 15-30 | Skills によるアプローチ（構造・遅延読込・実装例） |
| 30-35 | 実践ユースケース（技術領域 / 開発プロセスの特化） |
| 35-50 | ハンズオン（独自 Skill の作成 + Agentic Workflow） |
| 50-60 | ベストプラクティス + まとめ |
